...
<ul>
	...
	<li><a href="#?menu=product" target="_parent">Products</a>
		<ul>
			<li><a href="#" target="_parent">Ingersol Rand</a>
				<ul>
					<li><a href="product/air_compressor_solutions.php" target="_parent">Air Compressor Solution</a></li>
					<li><a href="http://www.arozone.com/en.html" target="_blank">ARO Fluid Products</a></li>
					<li><a href="product/air_electric_tools.php" target="_parent">Tools</a></li>
					<li><a href="product/lifting_material_handling.php" target="_parent">Lifting Material Handling</a></li>
				</ul>
			</li>
