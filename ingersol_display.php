...
<?php 
 $conn=mysql_connect("localhost","root","");
	...
	echo "<ul>";
	$res=mysql_query("select * from ingersol where division='".$division."' and category='".$category."' order by '".DECS."'",$conn);
	while($r=mysql_fetch_array($res))
	{
		echo "<li>";
		echo "<a href='ingersol/".$r['name']."' rel='example2' title='Product Name : '".$r['product_name']."'><img src='ingersol/".$r['name']."' alt='' /></a>";
